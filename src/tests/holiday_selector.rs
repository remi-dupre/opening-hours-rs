...
fn holidays() -> Result<(), Error> {
    ...
    assert_eq!(
        schedule_at!("2020:10:00-12:00; PH off", "2020-07-14", Country::FR),
        schedule! { 00,00 => Closed => 24,00 }
    );

    assert_eq!(
        schedule_at!("2020:10:00-12:00; PH off", "2020-07-14", Country::US),
    ...
    assert_eq!(
        schedule_at!("2020:10:00-12:00; PH off", "2020-07-03", Country::US),
        schedule! { 00,00 => Closed => 24,00 }
    );

    assert_eq!(
        schedule_at!("2020:10:00-12:00; PH off", "2020-07-04", Country::US),
        schedule! { 10,00 => Open => 12,00 }
    );
