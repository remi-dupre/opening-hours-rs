use crate::{datetime, Context, Localize, NoLocation, OpeningHours, TzLocation};
...
fn infer_tz() {
    ...
    let ctx =
        Context::default().with_locale(NoLocation::default().with_tz_from_coords(48.8535, 2.34839));
